package com.ljtao.dtxmqtxbank2.config;
...
public class MasterDataSourceConfig {
    ...
    static final String PACKAGE = "com.ljtao.dtxmqtxbank2.dao";
    static final String MAPPER_LOCATION = "classpath:mapper/*.xml";
    static final String TYPE_ALIASES_PACKAGE="com.ljtao.dtxmqtxbank2.entity";
